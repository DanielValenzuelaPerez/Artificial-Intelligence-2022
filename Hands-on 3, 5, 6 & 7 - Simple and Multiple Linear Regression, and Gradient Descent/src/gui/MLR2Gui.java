 ...
 */
public class MLR2Gui extends JFrame {	
	private MLR2Agent myAgent;
	
	private JTextField factor1, factor2;
	
	public MLR2Gui(MLR2Agent a) {
            ...
            addButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent ev) {
                            try {
                                    ...
                                    JOptionPane.showMessageDialog(MLR2Gui.this, "Invalid values. "+e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE); 
                            }
                    }
            } );
            p = new JPanel();
